...
import EditModal from "../AccountPage/components/EditModal";
import {
  MDBCol,
  MDBContainer,
  MDBRow,
    ...
    return( 
        <Container>
            <Row className="mt-5">
                ...
                {/* <div>
                   <Link  to={routes.login}>Ingresa</Link> o <Button as ={Link} to={routes.register} classNameName='ml-1'>Crea una cuenta</Button>
                </div> */}
                </Col>
                <Col>
