...
export default function EditModal ({isOpen, close, user}){
    ...
    <Modal show={isOpen} onHide={close}>
        ...
        <Modal.Body>
            <Form onSubmit={handleSubmit(onSubmit)}>
                <Form.Group>
                    ...
                    <Form.Control type='text'  placeholder='Escribe un nombre' {...register('name')}/>
                ...
                <Form.Group>
                    ...
                    <Form.Control type='email'  placeholder='Escribe un correo electrónico' {...register('email')}/>
        ...
        <Modal.Footer>
            ...
            <Button variant='primary' onClick={handleSubmit(onSubmit)} disabled={!isDirty}>Actualizar mi cuenta </Button>
        </Modal.Footer>
    </Modal>
    )
}